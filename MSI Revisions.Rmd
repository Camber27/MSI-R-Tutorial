...
data_path <- "D:\\Data Storage\\Converted IMZML Datasets\\KS_Zebrafish_2AuNP_5AuNP_DHB_20\\KS_Zebrafish_2AuNP_5AuNP_DHB_20.imzML"
```
...
# save created object
saveRDS(data_proc_ssc, file="data_proc_ssc_new.rds")
```
...
ssc <- image(data_proc_ssc, model=list(s=15))
ssc
```
...
saveRDS(data_proc_pca, file="data_proc_pca_new.rds")
```
